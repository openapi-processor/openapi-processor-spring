...
=== package-names ([.badge .badge-since]+new with 2025.3+)
...
=== [.line-through]#jackson ([.badge .badge-since]+new with 2026.3+)#

[NOTE]
do **not** use this. It is not necessary because jackson 3 still uses the jackson 2 package names.
