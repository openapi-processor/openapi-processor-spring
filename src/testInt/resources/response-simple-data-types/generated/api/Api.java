...
interface Api {
    ...
    @GetMapping(path = "/integer", produces = {"application/vnd.integer"})
    ResponseEntity<Integer> getInteger();

    @GetMapping(path = "/long", produces = {"application/vnd.long"})
    ResponseEntity<Long> getLong();

    @GetMapping(path = "/float", produces = {"application/vnd.float"})
    ResponseEntity<Float> getFloat();

    @GetMapping(path = "/double", produces = {"application/vnd.double"})
