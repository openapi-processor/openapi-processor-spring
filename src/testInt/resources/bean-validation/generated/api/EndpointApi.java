...
public interface EndpointApi {
    ...
    @GetMapping(
            path = "/endpoint/minmax"
    )
    ResponseEntity<Void> getEndpointMinmax(
            @DecimalMin("10") @RequestParam(name = "min", required = false) Integer min,
            @DecimalMin(value = "10", inclusive = false) @RequestParam(name = "min-ex", required = false) Integer minEx,
            @DecimalMax("20") @RequestParam(name = "max", required = false) Integer max,
            @DecimalMax(value = "20", inclusive = false) @RequestParam(name = "max-ex", required = false) Integer maxEx,
            @DecimalMin("10") @DecimalMax("20") @RequestParam(name = "min-max", required = false) Integer minMax,
    ...
    ResponseEntity<Void> getEndpointItems(
            ...
            @Size(min = 2, max = 4) @RequestParam(name = "min-max", required = false) String[] minMax);
